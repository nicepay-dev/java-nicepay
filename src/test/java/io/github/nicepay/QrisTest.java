...
import io.github.nicepay.service.v1.V1QrisService;
...
class QrisTest <T extends BaseNICEPayResponse> {
    ...
    @Test
    void qrisRegistV1() throws IOException
    {
        String timeStamp = V2_TIMESTAMP;
        ...
        NICEPayResponseV1 response =
                V1QrisService.callRegistration(qris,config);
    }
