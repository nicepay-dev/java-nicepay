...
import io.github.nicepay.service.v1.V1EwalletService;
...
//        V2
    ...
    //        V1
    @Test
    void ewalletRegistV1Enterprise() throws IOException, InterruptedException {

        String timeStamp = V2_TIMESTAMP;
        String reffNo = "ewJavaV1" + timeStamp;
        String iMid = "IONPAYTEST";
        String amount = "5000";
        ...
        Ewallet request = Ewallet.builder()
                ...
                .deliveryCountry("Indonesia")
                .dbProcessUrl("https://merchant.com/api/dbProcessUrl/Notif")
                .merchantToken(iMid, reffNo, amount, MERCHANT_KEY)
                .reqDomain("merchant.com")
                .reqServerIP("127.0.0.1")
                .reqClientVer("")
                .userAgent("Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML,like Gecko) Chrome/60.0.3112.101 Safari/537.36")
        ...
        NICEPayResponseV1 response = V1EwalletService.callRegistration(request, config);
