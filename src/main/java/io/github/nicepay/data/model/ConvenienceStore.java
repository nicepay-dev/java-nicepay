...
public class ConvenienceStore {
    ...
    public static class ConvenienceStoreBuilder {

        public ConvenienceStoreBuilder merchantToken(String timeStamp, String imid, String reffNo, String amount, String merchantKey) {
